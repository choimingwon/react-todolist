  ...
  return (
    <div className="Outer">
      <div className="InputArea">
        제목
        <input className="Input" value={title} onChange={(e) => setTitle(e.target.value)}></input>
        내용
        <input className="Input" value={contents} onChange={(e) => setContents(e.target.value)}></input>
        <CustomBtn buttonColor="#D2B48C" onClick={addTodoHandler}>
          추가하기
        </CustomBtn>
      </div>
      <div className="Outer">
